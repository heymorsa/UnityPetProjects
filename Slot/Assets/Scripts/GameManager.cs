...
public class GameManager : MonoBehaviour {
    ...
    private const int SpinCountToActivateButton = 10;
    ...
    private IEnumerator Spin()
    {
        ...
        _spinTime = Random.Range(1f, 1.5f);
        ...
        _spinCount++;
        if (_spinCount >= SpinCountToActivateButton)
        {
            _spinButton.SetActive(true); // Активируем кнопку
            _spinCount = 0;                  // Сбрасываем счетчик
        }
    }
